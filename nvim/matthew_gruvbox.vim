...
call s:Color('bright_green',   ['#b8bb26', 142])     " 184-187-38 originally #b8bb26 Matthew Change
...
call s:Color('neutral_green',  ['#98971a', 106])     " 152-151-26 originally #98971a Matthew Change
...
call s:HL('Comment', s:gb.aqua, s:none, s:italicize_comments) " Originally gb.gray Matthew change
...
" Function name
hi! link Function GruvboxGreenBold " Matthew Change Originally GruvboxGreenBold

" Generic preprocessor
hi! link PreProc GruvboxAqua
" Preprocessor #include
hi! link Include GruvboxRedBold " Originally GruvboxAqua Matthew Change
" Preprocessor #define
...
if g:gruvbox_improved_strings == 0
  call s:HL('String',  s:gb.fg3, s:none, s:italicize_strings) "Originally gb.green Matthew Change
else
  call s:HL('String',  s:gb.fg3, s:gb.bg1, s:italicize_strings) "Originally gb.fg1 Matthew Change
endif
...
hi! link Structure GruvboxAqua " Originally GruvboxAqua Matthew Change
" typedef
